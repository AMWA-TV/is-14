...
Authorization and transport security features described in the BCP-003 family and in IS-10 are used to secure and authorize this API.
...
More specifically [BCP-003-02](https://specs.amwa.tv/bcp-003-02/branches/v1.1-dev/docs/Authorization_Practice.html#is-14---device-configuration) has a dedicated section for how JSON Web Tokens can be created for this API.
