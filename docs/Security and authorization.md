...
More specifically [BCP-003-02](https://specs.amwa.tv/bcp-003-02/latest/docs/1.0._Authorization_Practice.html#nmos-apis) has dedicated sections for how JSON Web Tokens can be created.
